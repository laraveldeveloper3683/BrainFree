            ...
            <div class="row m-b-lg m-t-lg">
                <div class="col-md-6">
                    ...
                    <div class="profile-image">
                        <img src="/assets/img/a4.jpg" class="img-circle circle-border m-b-md" alt="profile">
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-5">
                    ...
                    <div class="social-feed-box">
                        ...
                        <div class="social-avatar">
                            <a href="" class="pull-left">
                                <img alt="image" src="/assets/img/a1.jpg">
                            </a>
                        ...
                        <div class="social-footer">
                            ...
                            <div class="social-comment">
                                <a href="" class="pull-left">
                                    <img alt="image" src="/assets/img/a2.jpg">
                                </a>
                                <div class="media-body">
                                    <a href="#">
                                        Andrew Williams
                            ...
                            <div class="social-comment">
                                <a href="" class="pull-left">
                                    <img alt="image" src="/assets/img/a3.jpg">
                                </a>
                                <div class="media-body">
                    ...
                    <div class="social-feed-box">
                        ...
                        <div class="social-avatar">
                            <a href="" class="pull-left">
                                <img alt="image" src="/assets/img/a6.jpg">
                            </a>
                            <div class="media-body">
                                <a href="#">
                                    Andrew Williams
                        ...
                        <div class="social-body">
                            ...
                            <img src="/assets/img/gallery/3.jpg" class="img-responsive">
                            <div class="btn-group">
                                <button class="btn btn-white btn-xs"><i class="fa fa-thumbs-up"></i> Like this!</button>
                                <button class="btn btn-white btn-xs"><i class="fa fa-comments"></i> Comment</button>
                                <button class="btn btn-white btn-xs"><i class="fa fa-share"></i> Share</button>
                        ...
                        <div class="social-footer">
                            ...
                            <div class="social-comment">
                                <a href="" class="pull-left">
                                    <img alt="image" src="/assets/img/a8.jpg">
                                </a>
                                <div class="media-body">
                                    <a href="#">
                                        Andrew Williams
