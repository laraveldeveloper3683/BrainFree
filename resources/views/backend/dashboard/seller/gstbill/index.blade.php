...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2>Customer's E-GST Bill list</h2>
        <ol class="breadcrumb">
    ...
    <div class="col-lg-2">
        <a href="/seller/seller/gstbills/generate"><button type="button" class="btn btn-w-m btn-primary" style="margin-top: 30px;">Generate Bill</button></a>
    </div>
</div>
