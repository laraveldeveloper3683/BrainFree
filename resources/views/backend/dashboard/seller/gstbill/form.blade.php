@extends('layouts.master')
    @section('content')
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                <h2>Customer's E-GST Bill Generate</h2>
                <ol class="breadcrumb">
            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        <form method="post" action = "/seller/seller/gstbills/form/submit" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="hr-line-dashed"></div>
                            <div class="form-group row"><label class="col-sm-2 col-form-label">Enter GST Number (If you have)</label>
                                <div class="col-sm-10"><input type="text" name="gst_number" class="form-control"></div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="hr-line-dashed"></div>
                            <div class="form-group row"><label class="col-sm-2 col-form-label">Total Gst in % ( Percentage )</label>
                                <div class="col-sm-10"><input type="text" name="gst_percentage" class="form-control"></div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group row"><label class="col-sm-2 col-form-label">Total Gst Amount</label>
                                <div class="col-sm-10"><input type="text" name="total_gst_price" class="form-control"></div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="hr-line-dashed"></div>
                            <div class="form-group row"><label class="col-sm-2 col-form-label">Customer's Photo</label>
                                <div class="col-sm-10"><input type="file" name="customer_photo" class="form-control"></div>
                            </div>
                            <div class="hr-line-dashed"></div>
