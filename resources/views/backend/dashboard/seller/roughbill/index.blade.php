...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2>Customer's Rough Bill list</h2>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <strong>Customer's Bill List</strong>
            </li>
        </ol>
    </div>
    <div class="col-lg-2">
        <a href="/seller/seller/roughbill/generate"><button type="button" class="btn btn-w-m btn-primary" style="margin-top: 30px;">Generate Bill</button></a>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="form-group">
                    <label class="col-form-label" for="product_name">Customer Name</label>
                    <input type="text" id="product_name" name="product_name" value="" placeholder="Product Name" class="form-control">
                </div>
            </div>
            <div class="col-sm-2">
                <div class="form-group">
                    <label class="col-form-label" for="price">Phone</label>
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    <label class="col-form-label" for="status">Quanitity</label>
                ...
                <div class="ibox-content">
                    <table class="footable table table-stripped toggle-arrow-tiny default breakpoint footable-loaded" data-page-size="15">
                        ...
                        <tr>
                            ...
                            <th data-hide="phone,tablet" class="footable-visible footable-sortable">Quantity<span class="footable-sort-indicator"></span></th>
